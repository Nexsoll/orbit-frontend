...
import 'auth0_service_stub.dart'
    if (dart.library.html) 'auth0_service_web.dart' as auth0_web;
  ...
  Future<String> loginWithSocialProvider(String connection) async {
    try {
      if (VPlatforms.isWeb) {
        ...
        final result = await _auth0.webAuthentication(scheme: Auth0Config.scheme).login(
          parameters: {
